...
# include <click/task.hh>
extern "C" {
void FromDevice_get_packet_netmap_zero_copy(u_char*, const struct pcap_pkthdr*, const u_char*, struct netmap_slot *);
}
#endif
...
#endif
#if FROMDEVICE_ALLOW_NETMAP
    friend void FromDevice_get_packet_netmap_zero_copy(u_char*, const struct pcap_pkthdr*, const u_char*, struct netmap_slot*);
#endif
